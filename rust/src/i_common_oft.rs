...
pub mod i_common_oft {
    ...
    pub static ICOMMONOFT_ABI: ::ethers::contract::Lazy<::ethers::core::abi::Abi> = ::ethers::contract::Lazy::new(
        __abi,
    );
    pub struct ICommonOFT<M>(::ethers::contract::Contract<M>);
    impl<M> ::core::clone::Clone for ICommonOFT<M> {
        fn clone(&self) -> Self {
            Self(::core::clone::Clone::clone(&self.0))
        }
    }
    impl<M> ::core::ops::Deref for ICommonOFT<M> {
        type Target = ::ethers::contract::Contract<M>;
        fn deref(&self) -> &Self::Target {
            &self.0
        }
    }
    impl<M> ::core::ops::DerefMut for ICommonOFT<M> {
        fn deref_mut(&mut self) -> &mut Self::Target {
            &mut self.0
        }
    }
    impl<M> ::core::fmt::Debug for ICommonOFT<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(::core::stringify!(ICommonOFT)).field(&self.address()).finish()
        }
    }
    impl<M: ::ethers::providers::Middleware> ICommonOFT<M> {
    ...
    impl ::ethers::core::abi::AbiEncode for ICommonOFTCalls {
    ...
    impl ::core::fmt::Display for ICommonOFTCalls {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
    ...
    impl ::core::convert::From<CirculatingSupplyCall> for ICommonOFTCalls {
        fn from(value: CirculatingSupplyCall) -> Self {
            Self::CirculatingSupply(value)
        }
    }
    impl ::core::convert::From<EstimateSendFeeCall> for ICommonOFTCalls {
        fn from(value: EstimateSendFeeCall) -> Self {
            Self::EstimateSendFee(value)
        }
    }
    impl ::core::convert::From<SupportsInterfaceCall> for ICommonOFTCalls {
        fn from(value: SupportsInterfaceCall) -> Self {
            Self::SupportsInterface(value)
        }
    }
    impl ::core::convert::From<TokenCall> for ICommonOFTCalls {

...
pub mod executor {
    ...
    #[rustfmt::skip]
    const __BYTECODE: &[u8] = b"`\x80\x80`@R4`\x13W`:\x90\x81`\x19\x829\xF3[`\0\x80\xFD\xFE`\0\x80\xFD\xFE\xA2dipfsX\"\x12 \x1C\xBF\xE8E\xE1\xFCT\x8F\x85\x84\x96z\x87_\xF6\xA3\xDB`\xBC\xA1\x02\x1D\xEF\x1F+\x07,&\xA8\xFFf\xE3dsolcC\0\x08\x13\x003";
    /// The bytecode of the contract.
    pub static EXECUTOR_BYTECODE: ::ethers::core::types::Bytes = ::ethers::core::types::Bytes::from_static(
        __BYTECODE,
    );
    #[rustfmt::skip]
    const __DEPLOYED_BYTECODE: &[u8] = b"`\0\x80\xFD\xFE\xA2dipfsX\"\x12 \x1C\xBF\xE8E\xE1\xFCT\x8F\x85\x84\x96z\x87_\xF6\xA3\xDB`\xBC\xA1\x02\x1D\xEF\x1F+\x07,&\xA8\xFFf\xE3dsolcC\0\x08\x13\x003";
    ...
    impl<M> ::core::fmt::Debug for Executor<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(::core::stringify!(Executor)).field(&self.address()).finish()
        }
    }
